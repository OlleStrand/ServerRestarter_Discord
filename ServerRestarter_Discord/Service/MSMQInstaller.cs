...
namespace ServerRestarter_Discord.Service
{
    class MSMQInstaller : Installer
    {
        ...
        public override void Install(IDictionary stateSaver)
        {
            ...
            if (!loaded)
            {
                DialogResult dialogResult = MessageBox.Show("License service needs to inteall MSMQ", "Install MSMQ",
                ...
                if (dialogResult == DialogResult.OK)
                {
                    ...
                    else // Vista or later
                    {
                        using (System.Diagnostics.Process p = new System.Diagnostics.Process())
                        {
                            System.Diagnostics.ProcessStartInfo start = new System.Diagnostics.ProcessStartInfo("dism.exe", "/Online /Quiet /NoRestart /Enable-Feature /FeatureName:MSMQ-Container /FeatureName:MSMQ-Server /LimitAccess");
